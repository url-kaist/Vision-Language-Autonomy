...
# JW
homebuilding_labels = [
    'kettle', 'glass', 'pillow', 'window', 'kitchen cabinet', 'cushion',
    'wall', 'sofa', 'table', 'chair', 'bed', 'cabinet', 'floor', 'trash can', 'door', 'bedside chest', 'nightstand', 'shower', 'light', 'bookshelf', 'picture', 'lamp', 'rug', 'plant', 'armchair', 'coffee table', 'counter', 'toilet', 'wardrobe', 'storage box', 'ceiling light', 'bathtub', 'sink', 'curtain', 'tv stand', 'fireplace', 'kitchen island', 'speaker', 'potted plant', 'dvd', 'trash can', 'ash tray', 'balcony railing', 'balcony door', 'quilt', 'matress', 'bedroom light', 'carpet', 'book', 'clock', 'dining chair', 'dining table','desk light', 'dish', 'dressing chair', 'dressing table', 'gate', 'wine glass', 'bottle', 'sculpture', 'magazine', 'lipstick', 'side table', 'photo', 'stove', 'mirror', 'toilet paper', 'towel', 'shower curtain', 'shower door', 'toilet brush', 'washing machine', 'dryer', 'kitchen hood', 'oven', 'microwave', 'refrigerator', 'dishwasher', 'broom', 'bucket', 'laundry basket', 'laundry detergent', 'iron board', 'iron', 'shoe rack', 'shoe cabinet', 'clothes rack', 'clothes dryer', 'clothes hanger', 'clothes basket', 'tv', 'tv cabinet', 'vase', 'candle', 'remote control', 'fan', 'air conditioner', 'heater', 'wine bottle', 'ottoman', 'stair', 'sofa cushion', 'door frame'
